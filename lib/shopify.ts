...
const productMap: Record<FormatoKey, Record<IntensitaKey, { miscela: string; image: string; kit: { variantId: string; price: number; quantity: string }; mese1: { variantId: string; price: number; quantity: string }; mesi3: { variantId: string; price: number; quantity: string } }>> = {
  "cialde-44mm": {
    leggero: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026877895002", price: 23, quantity: "60 cialde" },
    ...
    medio: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026884940122", price: 23, quantity: "60 cialde" },
    ...
    intenso: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026885169498", price: 23, quantity: "60 cialde" },
  ...
  "lavazza-espresso-point": {
    leggero: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026885235034", price: 25, quantity: "60 capsule" },
    ...
    medio: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026885562714", price: 25, quantity: "60 capsule" },
    ...
    intenso: {
      ...
      kit: { variantId: "gid://shopify/ProductVariant/54026885661018", price: 25, quantity: "60 capsule" },
